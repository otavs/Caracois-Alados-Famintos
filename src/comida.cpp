...
void Comida::inicializarImagens(){
	img_hotdog = al_load_bitmap("../res/img/hotdog.png");
	img_pizza = al_load_bitmap("../res/img/pizza.png");
	img_chocolate = al_load_bitmap("../res/img/chocolate.png");
	img_sushi = al_load_bitmap("../res/img/sushi.png");
}
