...
void Caracol::inicializarImagens(){
	img_c_hotdog[0] = al_load_bitmap("../res/img/c_hotdog0.png");
	img_c_hotdog[1] = al_load_bitmap("../res/img/c_hotdog1.png");
	img_c_sushi[0] = al_load_bitmap("../res/img/c_sushi0.png");
	img_c_sushi[1] = al_load_bitmap("../res/img/c_sushi1.png");
	img_c_chocolate[0] = al_load_bitmap("../res/img/c_chocolate0.png");
	img_c_chocolate[1] = al_load_bitmap("../res/img/c_chocolate1.png");
	img_c_pizza[0] = al_load_bitmap("../res/img/c_pizza0.png");
	img_c_pizza[1] = al_load_bitmap("../res/img/c_pizza1.png");
}
